		...
		<div class="container-fluid page-body-wrapper">
			...
			<div id="right-sidebar" class="settings-panel">
				...
				<div class="tab-content" id="setting-content">
					<div
						class="tab-pane fade show active scroll-wrapper ps ps--active-y"
						...
						<div class="ps__rail-y"
							style="top: 0px; height: 718px; right: 0px;">
							<div class="ps__thumb-y" tabindex="0"
								style="top: 0px; height: 579px;"></div>
						</div>
					</div>
												...
												<c:forEach items="${product}" var="p">
													<tr class="table-success">
														...
														<td><a href="deleteproduct/${p.productId}">Delete</a>
															<a href="editproduct?productId=${p.productId}">Edit</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
			...
			<c:forEach items="${product}" var="p">
				<tr>
					...
					<td><a href="deleteproduct/${p.productId}">Delete</a> <a
						href="editproduct?productId=${p.productId}">Edit</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table> --%>
